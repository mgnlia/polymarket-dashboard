...
export default function AirdropScore({ risk, rewards, marketCount }: Props) {
  // Heuristic $POLY airdrop score: volume + diversity + months active
  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5 backdrop-blur-sm">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-semibold text-slate-300">$POLY Airdrop Score Estimator</h3>
